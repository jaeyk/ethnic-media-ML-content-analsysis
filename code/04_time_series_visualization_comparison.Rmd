...
ggsave("/home/jae/content-analysis-for-evaluating-ML-performances/outputs/matched_comparison_year.png")
```
...
ggsave("/home/jae/content-analysis-for-evaluating-ML-performances/outputs/matched_comparison_source.png", width = 13)
...
ggsave("/home/jae/content-analysis-for-evaluating-ML-performances/outputs/matched_comparison_comp.png", width = 13)
...
matched_ratio <- df %>%
  filter(year >= 1976 & year <= 1981) %>%
  visualize_ratio() +
    labs(title = "Matched", y = "Ratio", x = "Group") + ylim(c(0,16))
            
unmatched_ratio <- df %>%
 visualize_ratio() +
    labs(title = "Unmatched", y = "Ratio", x = "Group") + ylim(c(0,16))

ggarrange(matched_ratio, unmatched_ratio, common.legend = TRUE, ncol = 1) 

ggsave("/home/jae/content-analysis-for-evaluating-ML-performances/outputs/matched_comparison_ratio.png", height = 10)
