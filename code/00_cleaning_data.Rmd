...
table(asian_full$source)

table(black_full$source)

# Calculating the total number of observations 

length(asian_full$text) + length(black_full$text)
...
NA_dictionary <- dictionary(list(sports = c("football", "basketball", "golf", "tennis", "swimming", "coach", "giants", "warriors", "raiders", "49ers", "track team", "track and field", "athletes"),
                                 ...
                                 arts = c("art","arts","film", "films", "museum", "galleries", "painting", "paintings", "theater", "television", "circus", "opera", "orchestra", "symphony", "jazz", "disco", "concert", "concerts", "festival", "festivals", "artists", "artist", "singer", "musician", "musicians", "pianist", "pianists", "guitarists", "guitarist", "ticket", "tickets", "beautiful", "violin"),
