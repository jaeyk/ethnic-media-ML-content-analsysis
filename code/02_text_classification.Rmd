...
trainIndex <- createDataPartition(meta[[measure]], p = 0.8, list = FALSE, times = 1)
...
plot_asian_lp <- build_test(asian_lp) + 
    theme_clean() + ggtitle("Linked progress in Asian American newspapers")

plot_asian_lh <- build_test(asian_lh) + 
    theme_clean() + ggtitle("Linked hurt in Asian American newspaeprs")

plot_black_lp <- build_test(black_lp) + 
    theme_clean() + ggtitle("Linked progress in African American newspapers")

plot_black_lh <- build_test(black_lh) + 
    theme_clean() + ggtitle("Linked hurt in African American newspapres")

ggarrange(plot_asian_lp, plot_asian_lh, plot_black_lp, plot_black_lh)
