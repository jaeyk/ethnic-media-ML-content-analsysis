...
asian_lp_boosted <- asian_lp_model[[1]][[3]] 

preds <- predict(asian_lp_boosted, dtm)
...
asian_lp_full <- predict_unlabeled(unlabeled_asian, 'linked_progress')
asian_lh_full <- predict_unlabeled(unlabeled_asian, 'linked_hurt')

black_lp_full <- predict_unlabeled(unlabeled_black, 'linked_progress')
black_lh_full <- predict_unlabeled(unlabeled_black, 'linked_hurt')
