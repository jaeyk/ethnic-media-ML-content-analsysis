...
asian_lp_models <- read_csv(make_here("/home/jae/content-analysis-for-evaluating-ML-performances/processed_data/asian_lp_models.csv"))[,-1]

asian_lh_models <- read_csv(make_here("/home/jae/content-analysis-for-evaluating-ML-performances/processed_data/asian_lh_models.csv"))[,-1]

black_lp_models <- read_csv(make_here("/home/jae/content-analysis-for-evaluating-ML-performances/processed_data/black_lp_models.csv"))[,-1]

black_lh_models <- read_csv(make_here("/home/jae/content-analysis-for-evaluating-ML-performances/processed_data/black_lh_models.csv"))[,-1]
...
black_lp_models_resample <- read_csv(make_here("/home/jae/content-analysis-for-evaluating-ML-performances/processed_data/black_lp_models_resample.csv"))[,-1]

black_lh_models_resample <- read_csv(make_here("/home/jae/content-analysis-for-evaluating-ML-performances/processed_data/black_lh_models_resample.csv"))[,-1]
...
write.csv(merged_model, make_here("/home/jae/content-analysis-for-evaluating-ML-performances/processed_data/merged_model100.csv"))
```
...
ggsave(make_here("/home/jae/content-analysis-for-evaluating-ML-performances/outputs/ml_performances.png"), height = 17, width = 10)
...
ggsave(make_here("/home/jae/content-analysis-for-evaluating-ML-performances/outputs/ml_content.png"), height = 17, width = 10)
```
