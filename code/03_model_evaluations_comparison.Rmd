...
asian_lp_models <- read_csv("asian_lp_models.csv")[,-1]
asian_lh_models <- read_csv("asian_lh_models.csv")[,-1]

black_lp_models <- read_csv("black_lp_models.csv")[,-1]
black_lh_models <- read_csv("black_lh_models.csv")[,-1]

asian_lp_models_gran <- read_csv("asian_lp_models_gran.csv")[,-1]
asian_lh_models_gran <- read_csv("asian_lh_models_gran.csv")[,-1]

black_lp_models_gran <- read_csv("black_lp_models_gran.csv")[,-1]
black_lh_models_gran <- read_csv("black_lh_models_gran.csv")[,-1]

# Resampled 

asian_lp_models_resample <- read_csv("asian_lp_models_resample.csv")[,-1]
asian_lh_models_resample <- read_csv("asian_lh_models_resample.csv")[,-1]

black_lp_models_resample <- read_csv("black_lp_models_resample.csv")[,-1]
black_lh_models_resample <- read_csv("black_lh_models_resample.csv")[,-1]

asian_lp_models_resample_gran <- read_csv("asian_lp_models_resample_gran.csv")[,-1]
asian_lh_models_resample_gran <- read_csv("asian_lh_models_resample_gran.csv")[,-1]

black_lp_models_resample_gran <- read_csv("black_lp_models_resample_gran.csv")[,-1]
black_lh_models_resample_gran <- read_csv("black_lh_models_resample_gran.csv")[,-1]

# From content analysis: Correlation coefficients and Kappa statistics 

irr_summary <- read_csv("irr_summary.csv")[,-1]
