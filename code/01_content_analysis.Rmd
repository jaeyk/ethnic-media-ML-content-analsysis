...
```{r}
# Cross Tabs
CrossTable(training_asian$linked_progress, training_asian$linked_progress_gran)
CrossTable(training_asian$linked_hurt, training_asian$linked_hurt_gran)
CrossTable(training_black$linked_progress, training_black$linked_progress_gran)
CrossTable(training_black$linked_hurt, training_black$linked_hurt_gran)
...
df %>%
  ...
  ggplot(aes(x = fct_reorder(type, mean), y = mean, ymax = upper.ci, ymin = lower.ci, col = group)) +
    ...
    labs(y= "Percentages of Agreement", x = "Type",
         ...
         subtitle = "1: 100% agreement, 0: Zero agreement",
...
ggarrange(
df %>%fg/f./fflgbbgg ghbhg h  h h                      cvv vgxcdc
...
(train_asian_plot + labs(subtitle = "100% agreement") + train_black_plot + labs(subtitle = "100% agreement")) /
(train_asian_plot_gran + labs(subtitle = "50% agreement") + train_black_plot_gran + labs(subtitle = "50% agreement"))
