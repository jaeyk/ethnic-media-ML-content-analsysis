...
plot_ext_cases <- df_source %>%
 ...
 ggplot(aes(x = fct_reorder(type, mean), y = mean, fill = linked_fate)) +
    ...
    labs(title = "The proportion of extreme cases by category",
         y = "Proportion", x = "Threshold") +
    facet_wrap(~group)
...
df_ratio_plot <- df_ratio %>%
  ...
  ggplot(aes(x = fct_reorder(type, mean), y = mean)) +
    ...
    labs(title = "The proportion of extreme cases", y = "Proportion", x = "Threshold") +
    facet_wrap(~group)

df_ratio_plot + plot_ext_cases
