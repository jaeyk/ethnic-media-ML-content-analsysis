...
### 3.2. Inter-coder reliablity scores 
...
extract_kappa <- function(data){
  # Calculatign the percent agreement 
  test <- kappa2(data, "squared") %>% as.numeric()
  # Extracting the number
  kappa <- test[5]
  # Return the number
  kappa
...
df_kappa %>%
  ...
  ggplot(aes(x = group, y = kappa, fill = type)) +
  geom_col(position = "dodge", color="black") +
...
ggsave("/home/jae/content-analysis-for-evaluating-ML-performances/outputs/content_analysis_kappa.png", height = 7)
