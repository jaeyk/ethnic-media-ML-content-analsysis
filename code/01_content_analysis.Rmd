...
ggsave("/home/jae/content-analysis-for-evaluating-ML-performances/outputs/content_analysis_n_count.png", height = 7)
```
...
irr_summary %>%
  ...
  ggplot(aes(x = fct_reorder(type, value), y = value, fill = group)) +
    ...
    labs(y= "Cohen's Kappa scores", x = "Type",
         title = "Inter-coder reliablity test results",
