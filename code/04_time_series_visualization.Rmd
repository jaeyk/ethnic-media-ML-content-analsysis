...
year_trends <- full_articles %>%
  ...
  stat_summary(fun.y = mean, geom = "point", alpha = 0.8, size = 1.5) +
  stat_summary(fun.data = mean_se, geom = "errorbar", fun.args = list(mult= 1.96), alpha = 0.4) +
...
ggsave("/home/jae/content-analysis-for-evaluating-ML-performances/outputs/time_series_plot.png", height = 10)

```

```{r}

year_trends + facet_wrap(~source)
ggsave("/home/jae/content-analysis-for-evaluating-ML-performances/outputs/time_series_source.png")
