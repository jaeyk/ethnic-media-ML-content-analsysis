...
ggsave("/home/jae/content-analysis-for-evaluating-ML-performances/outputs/time_series_plot.png", height = 10, width = 13)
...
full_articles %>%
  filter(year >= 1983 & year <= 1987 & group == "Asian Americans") %>%
  gather(linked_fate, value, lp_exclusive, lh_exclusive, lf_mixed) %>%
  group_by(group, source, linked_fate) %>%
