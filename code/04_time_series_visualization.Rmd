...
### 2.2. Joining labeled and unlabeled articles 
...
ggarrange(year_trends, month_trends, nrow = 1, ncol = 2, common.legend = TRUE)

ggsave("/home/jae/content-analysis-for-evaluating-ML-performances/outputs/time_series_plot.png", height = 7, width = 15)
...
time_series_black <- full_articles %>% filter(group == "African Americans") %>% group_by(year_mon) %>% visualize_month_trends() + facet_wrap(~source, ncol = 1) + labs(title = "", subtitle = "African Americans", caption = "")

ggarrange(time_series_asian, time_series_black, common.legend = TRUE, ncol = 2)

ggsave("/home/jae/content-analysis-for-evaluating-ML-performances/outputs/time_series_source.png", height = 13, width = 15)
...
ggsave("/home/jae/content-analysis-for-evaluating-ML-performances/outputs/matched_comparison.png", height = 7)
...
write.csv(full_articles, "/home/jae/content-analysis-for-evaluating-ML-performances/processed_data/full_articles.csv")
