...
# Predicted values
asian_lp_data <- read_csv(make_here("/home/jae/content-analysis-for-evaluating-ML-performances/processed_data/asian_lp_data_gran.csv"))

asian_lh_data <- read_csv(make_here("/home/jae/content-analysis-for-evaluating-ML-performances/processed_data/asian_lh_data_gran.csv"))

black_lp_data <- read_csv(make_here("/home/jae/content-analysis-for-evaluating-ML-performances/processed_data/black_lp_data_gran.csv"))

black_lh_data <- read_csv(make_here("/home/jae/content-analysis-for-evaluating-ML-performances/processed_data/black_lh_data_gran.csv"))
...
## Joining labeled and unlabled articles 
...
write_csv(full_articles, here("processed_data", "full_articles_gran.csv"))
...
ggsave(make_here("/home/jae/content-analysis-for-evaluating-ML-performances/outputs/time_series_plot_gran.png"), height = 10, width = 13)
...
ggsave(make_here("/home/jae/content-analysis-for-evaluating-ML-performances/outputs/time_series_source_gran.png"), height = 13, width = 15)
...
ggsave(make_here("/home/jae/content-analysis-for-evaluating-ML-performances/outputs/matched_comparison_gran.png"), height = 7)
...
write.csv(full_articles, make_here("/home/jae/content-analysis-for-evaluating-ML-performances/processed_data/full_articles_gran.csv"))
