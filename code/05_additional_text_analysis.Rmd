...
word_frequency <- create_word_frequency(tokenized_articles, 20, 20)

word_frequency_gran <- create_word_frequency(tokenized_articles_gran, 20, 20)
...
wf <- filter_words(word_frequency) 

wfg <- filter_words(word_frequency_gran)
